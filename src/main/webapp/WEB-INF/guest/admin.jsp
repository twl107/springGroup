...
<p><br/></p>
<div class="container">
  <form name="myform" method="post" action="${ctp}/study2/guest/AdminOk.gu">
      ...
      <tr>
        <td colspan="2">
          <div class="mb-2">
	          ...
	          <input type="button" value="돌아가기" onclick="location.href='GuestList.gu'" class="btn btn-info me-2"/>
          </div>
        </td>
      </tr>
    </table>
